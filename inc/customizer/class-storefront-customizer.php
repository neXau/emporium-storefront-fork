...
if ( ! class_exists( 'Storefront_Customizer' ) ) :
	...
	class Storefront_Customizer {
		 ...
		 *
		 * @return array $emporium_theme_mods The Storefront Theme Mods.
		 */
		public function get_storefront_theme_mods() {
			$emporium_theme_mods = array(
			 ...
			 * @since    2.0.0
			 */
			return apply_filters( 'storefront_theme_mods', $emporium_theme_mods );
		}
		...
		public function get_css() {
			...
			button.menu-toggle,
			button.menu-toggle:hover {
				border-color: ' . $emporium_theme_mods['header_link_color'] . ';
			}
			...
			table:not( .has-background ) tbody td {
				background-color: ' . storefront_adjust_color_brightness( $emporium_theme_mods['background_color'], -2 ) . ';
			}

			table:not( .has-background ) tbody tr:nth-child(2n) td,
			fieldset,
			fieldset legend {
				background-color: ' . storefront_adjust_color_brightness( $emporium_theme_mods['background_color'], -4 ) . ';
			}
			...
			button.menu-toggle,
			button.menu-toggle:hover {
				background-color: ' . $emporium_theme_mods['header_background_color'] . ';
			}
			...
			h1, h2, h3, h4, h5, h6, .wc-block-grid__product-title {
				color: ' . $emporium_theme_mods['heading_color'] . ';
			}

			.widget h1 {
				border-bottom-color: ' . $emporium_theme_mods['heading_color'] . ';
			}
			...
			.site-footer {
				background-color: ' . $emporium_theme_mods['footer_background_color'] . ';
				color: ' . $emporium_theme_mods['footer_text_color'] . ';
			}

			.site-footer a:not(.button):not(.components-button) {
				color: ' . $emporium_theme_mods['footer_link_color'] . ';
			}
			...
			.site-footer h1, .site-footer h2, .site-footer h3, .site-footer h4, .site-footer h5, .site-footer h6, .site-footer .widget .widget-title, .site-footer .widget .widgettitle {
				color: ' . $emporium_theme_mods['footer_heading_color'] . ';
			}

			.page-template-template-homepage.has-post-thumbnail .type-page.has-post-thumbnail .entry-title {
				color: ' . $emporium_theme_mods['hero_heading_color'] . ';
			}

			.page-template-template-homepage.has-post-thumbnail .type-page.has-post-thumbnail .entry-content {
				color: ' . $emporium_theme_mods['hero_text_color'] . ';
			}

			@media screen and ( min-width: 768px ) {
				.secondary-navigation ul.menu a:hover {
					color: ' . storefront_adjust_color_brightness( $emporium_theme_mods['header_text_color'], $brighten_factor ) . ';
				}
				...
				.site-header {
					border-bottom-color: ' . storefront_adjust_color_brightness( $emporium_theme_mods['header_background_color'], -15 ) . ';
				}
			}';
		...
		public function gutenberg_get_css() {
			...
			$styles = '
				...
				.rtl .wc-block-components-price-slider__range-input-progress {
					--range-color: ' . $emporium_theme_mods['accent_color'] . ';
				}

				/* Target only IE11 */
				@media all and (-ms-high-contrast: none), (-ms-high-contrast: active) {
					.wc-block-components-price-slider__range-input-progress {
						background: ' . $emporium_theme_mods['accent_color'] . ';
					}
				}
				...
				.wc-block-cart__submit-container::before {
					color: ' . storefront_adjust_color_brightness( $emporium_theme_mods['background_color'], is_color_light( $emporium_theme_mods['background_color'] ) ? -35 : 70, 0.5 ) . ';
				}

				.wc-block-components-order-summary-item__quantity {
					background-color: ' . $emporium_theme_mods['background_color'] . ';
					border-color: ' . $emporium_theme_mods['text_color'] . ';
					box-shadow: 0 0 0 2px ' . $emporium_theme_mods['background_color'] . ';
					color: ' . $emporium_theme_mods['text_color'] . ';
				}
			';
